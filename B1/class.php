...
<head>
    ...
    <style>
        ...
        .header { background-color: gray; color: #fff; padding: 10px; margin-bottom: 20px; display: flex; justify-content: space-between; align-items: center;}
        .header h2 { margin: 0; }
        .add-class-btn { background-color: wheat; color: white; padding: 8px 16px; border: none; cursor: pointer; }
